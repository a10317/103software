...
/**
 * TabelleNotizController implements the CRUD actions for TabelleNotiz model.
 */
class TabelleNotizController extends Controller
{
    ...
    /**
     * Lists all TabelleNotiz models.
     * @return mixed
     */
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => TabelleNotiz::find(),
        ]);
    ...
    /**
     * Displays a single TabelleNotiz model.
     * @param integer $id
     * @return mixed
     */
...
//        }
    ...
    /**
     * Deletes an existing TabelleNotiz model.
    ...
    /**
     * Finds the TabelleNotiz model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TabelleNotiz the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TabelleNotiz::findOne($id)) !== null) {
            return $model;
        } else {
